# Preserved OpenGD77 Downloads

For some time now, the official OpenGD77 website (`opengd77.com`) has been offline due to a prolonged DDoS attack. To help preserve access to important files that were previously hosted there, especially those under the `/downloads` section, I’ve mirrored the content in this repository.

## Access via GitHub Pages

The preserved files are also available via GitHub Pages for convenient browsing and download:

- [PC_CPS/Latest](https://ctassisf.github.io/www.opengd77.com/downloads/PC_CPS/Latest/)
- [GD77](https://ctassisf.github.io/www.opengd77.com/downloads/GD77/)
...
This repository is **not affiliated with the original OpenGD77 developers**. It exists solely to preserve public access to files that were once freely available on `opengd77.com`.

If and when the original site returns, consider using it as the official source.
